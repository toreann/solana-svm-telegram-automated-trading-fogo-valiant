...
const envSchema = z.object({
  ...
  TELEGRAM_POLL_INTERVAL_SECONDS: z.coerce.number().positive().default(30),
  TELEGRAM_POLL_LIMIT: z.coerce.number().int().positive().default(20),
  TELEGRAM_MAX_SIGNAL_AGE_SECONDS: z.coerce.number().positive().default(10 * 60),
  TELEGRAM_STALE_EXIT_SECONDS: z.coerce.number().positive().default(3 * 60),
  VALIANT_WALLET_CHECK_INTERVAL_MINUTES: z.coerce.number().positive().default(60),
...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    telegramPollLimit: env.TELEGRAM_POLL_LIMIT,
    telegramMaxSignalAgeSeconds: env.TELEGRAM_MAX_SIGNAL_AGE_SECONDS,
    telegramStaleExitSeconds: env.TELEGRAM_STALE_EXIT_SECONDS,
    valiantWalletCheckIntervalMinutes: env.VALIANT_WALLET_CHECK_INTERVAL_MINUTES,
